    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-6">
                ...
                <p>Learn from industry experts and enhance your technical skills.</p>
                ...
                <div class="event-card">
                    <div class="card h-100">
                        <div class="card-body">
                            ...
                            <p class="text-muted">Showcase your coding skills in C++, Java, and Web Development challenges.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="event-card">
                    <div class="card h-100">
                        <div class="card-body">
                            ...
                            <h5>System Assembly Competition</h5>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card h-100">
                    <div class="card-body">
                        <i class="fas fa-code fa-3x mb-3"></i>
                        <h5>Programming</h5>
                        <p class="text-muted">Master modern programming languages and development techniques.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <h5>Data Science</h5>
                        <p class="text-muted">Learn data analysis, machine learning, and statistical methods.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="card h-100">
                    <div class="card-body">
                        <i class="fas fa-network-wired fa-3x mb-3"></i>
                        <h5>Networking</h5>
                        <p class="text-muted">Understand computer networks, protocols, and security.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
